...
dotnet run --project .\tests\SentimentFS.NaiveBayes.Tests\SentimentFS.NaiveBayes.Tests.fsproj
dotnet pack .\src\SentimentFS.NaiveBayes\SentimentFS.NaiveBayes.fsproj --configuration Release --include-symbols --include-source
